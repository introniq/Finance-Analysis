              ...
              <Card className="shadow-sm border-0 h-100 mb-3">
                ...
                <Card.Body className="p-1 d-flex flex-column">
                  <div className="w-100 overflow-auto" style={{ maxHeight: 240, scrollbarWidth: 'auto' }}>
                    <style>{`
                      .tpo-scroll::-webkit-scrollbar{width:8px;height:8px}
                      .tpo-scroll::-webkit-scrollbar-thumb{background:#888;border-radius:4px}
                      .tpo-scroll::-webkit-scrollbar-track{background:#f1f1f1}
                    `}</style>
